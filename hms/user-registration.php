...
<form action="user-registration.php" method="post" style="border:1px solid #ccc">
  <div class="container">
    <h1>Sign Up</h1>
    ...
    <input type="date" name="dob" placeholder="Type your date of birth" required="required" />
